...
import 'package:visionart_mobile/presentation/widgets/ai_playlist_player.dart';
    ...
    return AppBackgroundWrapper(
      child: Stack(
        ...
        children: [
          ...
          if (_userPreferences != null && _userPreferences!.playlistUrls.isNotEmpty)
            Positioned(
              bottom: 0,
              left: 0,
              right: 0,
              child: AiPlaylistPlayer(),
            ),
        ],
      ),
    );
