...
class _PostDetailScreenState extends State<PostDetailScreen> {
  ...
  Future<void> _analyzeArt() async {
    ...
    try {
      final critic = CriticService();
      final feedback = await critic.analyzeArt(
        imageUrl: widget.imageUrl!,
        prompt: widget.quote, // Use the quote as context prompt
      );
      if (mounted) {
          ...
          child: Column(
            children: [
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    Icon(Icons.psychology_alt, color: AppColors.primaryBlue, size: 28),
