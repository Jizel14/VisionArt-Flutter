    ...
    return SingleChildScrollView(
      ...
      child: Column(
        children: [
          ...
          // Avatar
          _ProfileAvatar(initialAvatarUrl: avatarUrl),
          const SizedBox(height: 16),
          Text(
            userName,
...
class _ProfileAvatar extends StatefulWidget {
  ...
  const _ProfileAvatar({this.initialAvatarUrl});
        ...
        return SafeArea(
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 16),
              ListTile(
               leading: Icon(Icons.photo_library_rounded, color: AppColors.primaryBlue),
                title: Text('Modifier la photo de profil (Galerie)', style: TextStyle(color: textPrimary)),
                onTap: () {
              ...
              ListTile(
                ...
                title: Text('Modifier la photo de profil (Caméra)', style: TextStyle(color: textPrimary)),
                onTap: () {
                  Navigator.pop(context);
              ...
              ListTile(
                leading: Icon(Icons.add_box_rounded, color: AppColors.accentPink),
                title: Text('Publier une photo', style: TextStyle(color: textPrimary)),
                onTap: () {
                  Navigator.pop(context);
        ...
        Container(
          ...
          child: _selectedImage != null
              ...
              : (widget.initialAvatarUrl != null && widget.initialAvatarUrl!.isNotEmpty)
                  ? Image.network(widget.initialAvatarUrl!, fit: BoxFit.cover)
                  : Icon(
          ...
          child: GestureDetector(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                shape: BoxShape.circle,
                border: Border.all(color: context.cardBackgroundColor, width: 2),
                boxShadow: [
                  BoxShadow(
