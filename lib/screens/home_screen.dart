...
import '../presentation/screens/create/import_art_screen.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Future<void> _loadProfile() async {
    try {
      ...
      if (e.toString().contains('SessionExpired')) {
        if (mounted) {
            ...
            children: [
              ListTile(
                leading: Container(
                  ...
                  child: Icon(Icons.image, color: AppColors.primaryPurple),
                ),
                title: Text(
                  'Importer une image',
                  style: TextStyle(
                ...
                onTap: () {
                  ...
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (_) => const ImportArtScreen()),
                  );
                },
              ),
            ],
  ...
  Widget build(BuildContext context) {
    ...
    return Expanded(
      child: GestureDetector(
        onDoubleTap: isSelected ? onTap : null,
        child: InkWell(
          onTap: onTap,
          child: Container(
