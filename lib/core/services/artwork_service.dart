...
class ArtworkService {
  ...
  Future<ArtworkModel> styleTransfer({
    ...
    final response = await _dio.post('/social/artworks/style-transfer', data: payload);
    return ArtworkModel.fromJson(response.data as Map<String, dynamic>);
  }
