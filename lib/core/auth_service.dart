...
class AuthService {
  ...
  Future<AuthResult> login(String email, String password) async {
    try {
      ...
      throw ApiException(
        ...
        msg is List ? msg.join(', ') : msg?.toString() ?? e.toString()
      );
    }
  }
  ...
  Future<Map<String, dynamic>> getProfile() async {
    ...
    try {
      ...
      if (e.response?.statusCode == 401 || e.error is SessionExpiredException) {
        await clearToken();
        throw SessionExpiredException(401, 'Session expired. Please login again.');
      }
      rethrow;
    }
  }
