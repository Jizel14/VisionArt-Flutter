...
class AppConfig {
  ...
  static Future<void> init() async {
    ...
    apiBaseUrl =
        (envLoaded ? dotenv.env['API_BASE_URL'] : null) ??
    ...
    visionCraftApiKey =
        (envLoaded ? dotenv.env['VISIONCRAFT_API_KEY'] : null) ??
        const String.fromEnvironment(
          'VISIONCRAFT_API_KEY',
          defaultValue: '',
        );
    ...
    visionCraftBaseUrl =
        (envLoaded ? dotenv.env['VISIONCRAFT_BASE_URL'] : null) ??
        const String.fromEnvironment(
    ...
    googleWebClientId =
        (envLoaded ? dotenv.env['GOOGLE_WEB_CLIENT_ID'] : null) ??
        const String.fromEnvironment(
